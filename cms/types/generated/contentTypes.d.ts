...
export interface ApiCodeOfConductCodeOfConduct extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable Code of Conduct copy (replaces hard-coded index.html section).';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A BrisJS meetup event.';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiFindUsFindUs extends Struct.SingleTypeSchema {
  collectionName: 'find_uses';
  info: {
    description: 'Editable venue / find-us copy (replaces hard-coded index.html section).';
    displayName: 'Find Us';
    pluralName: 'find-uses';
    singularName: 'find-us';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accessibility: Schema.Attribute.RichText;
    ...
    parking: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable home-page intro copy (replaces hard-coded index.html intro).';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatWeDo: Schema.Attribute.RichText;
  };
}
...
export interface ApiJobPostingJobPosting extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A job/employment posting (replaces label-filtered GitHub issues).';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['open', 'filled', 'closed']> &
      Schema.Attribute.DefaultTo<'open'>;
    submittedDate: Schema.Attribute.Date;
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A BrisJS organizer shown on the contact list (replaces data/contact.json).';
...
export interface ApiSpeakerSpeaker extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A person who presents one or more talks.';
    displayName: 'Speaker';
    pluralName: 'speakers';
...
export interface ApiTalkRequestTalkRequest extends Struct.CollectionTypeSchema {
  collectionName: 'talk_requests';
  info: {
    description: 'A request for a talk on a topic (replaces label-filtered GitHub issues).';
    displayName: 'Talk Request';
    pluralName: 'talk-requests';
    singularName: 'talk-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['open', 'scheduled', 'declined']> &
      Schema.Attribute.DefaultTo<'open'>;
    submittedDate: Schema.Attribute.Date;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTalkTalk extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A talk given at a BrisJS meetup.';
    displayName: 'Talk';
    pluralName: 'talks';
    singularName: 'talk';
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::talk.talk'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slidesUrl: Schema.Attribute.String;
